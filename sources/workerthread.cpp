...
/*
    ...
    and creates threads based no of cpu cores. All the the created threads are 
    made to wait on condtional variable untill command available on queue. Once
    command is available the commands is processed and the task available within 
    the command is processed and proceed to fetch new command in the queue. 
*/
